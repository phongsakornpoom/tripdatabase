...
$sql = "DELETE FROM empchann_ntcdivedb.trip_passenger WHERE passengerid='{$id}' AND tripid='{$tripid}'";
...
<head>
    ...
    <title>Delete Passenger from Trip</title>
    <!-- Get Css -->
        ...
        <div class="row">
            <div class="col-12">
                <table width="100%" cellpadding="5" cellspacing="5">
                    <tr>
                        <td>
                            <h2>Delete Passenger from trip</h2>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: center;">
                            <?php
                                if($conn->query($sql) == TRUE){
                                    echo "<div id='message'>Delete Passenger from trip successfully <hr/>Please wait to redirect...</div>";
